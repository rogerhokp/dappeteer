...
export declare const profileDropdownClick: (page: DappeteerPage, expectToClose?: boolean) => Promise<void>;
export declare const openAccountDropdown: (page: DappeteerPage) => Promise<void>;
